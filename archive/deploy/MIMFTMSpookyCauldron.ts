...
const deployFunction: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const collateral = "0x6f86e65b255c9111109d2D2325ca2dFc82456efc"; // MIM/FTM
  const oracleProxy = await ethers.getContract<ProxyOracle>("MimFTMSpookyProxyOracle");
  ...
  deployments.save("MimFtmSpookyCauldron", {
    abi: [],
...
deployFunction.tags = ["MimFtmSpookyCauldron"];
deployFunction.dependencies = ["MimFTMSpookyOracles", "MimFtmSpookySwappers"];
