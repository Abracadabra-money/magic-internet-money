import { HardhatRuntimeEnvironment } from "hardhat/types";
 ...
 const deployFunction: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
   ...
   // Liquidation Swapper
   await deploy("PopsicleUsdcAvaxSwapperV2", {
     from: deployer,
     args: [parameters.limone],
     log: true,
     contract: "UsdceAvaxSwapperV2",
     deterministicDeployment: false,
   });
 
   // Leverage Swapper
   await deploy("PopsicleUsdcAvaxLevSwapperV2", {
     from: deployer,
     args: [parameters.limone],
     log: true,
     contract: "UsdceAvaxLevSwapperV2",
     deterministicDeployment: false,
   });
 };
 ...
 deployFunction.tags = ["PopsicleUsdceWavaxV2"];
