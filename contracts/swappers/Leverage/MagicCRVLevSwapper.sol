...
contract MagicCRVLevSwapper {
    ...
    function swap(
        ...
        // MIM -> USDT
        uint256 amount = MIM3POOL.exchange_underlying(0, 3, amountFrom, 0, address(this));
        ...
        // WETH -> CRV
        amount = CRVETH.exchange(0, 1, amount, 0, address(DEGENBOX));

        (, shareReturned) = DEGENBOX.deposit(CRV, address(DEGENBOX), recipient, amount, 0);
