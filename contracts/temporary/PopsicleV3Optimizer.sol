 ...
 */
contract ERC20Impl is Context, IERC20 {
    using LowGasSafeMath for uint256;
 ...
 * _Available since v3.4._
 */
abstract contract ERC20Permit is ERC20Impl, IERC20Permit, EIP712 {
...
contract PopsicleV3Optimizer is ERC20Permit, ReentrancyGuard, IPopsicleV3Optimizer {
     ...
     */
     constructor(
        address _pool,
        address _strategy
    ) ERC20Impl("Popsicle LP V3 USDT/WETH", "PLP") ERC20Permit("Popsicle LP V3 USDT/WETH") {
