...
contract CauldronV2CheckpointV2 is BoringOwnable, IMasterContract, ICollateralAmountAware {
    ...
    CauldronV2CheckpointV2 public immutable masterContract;
    ...
    function addCollateral(
        ...
        ICheckpointTokenV2(address(collateral)).onCheckpoint(to);
    ...
    function _removeCollateral(address to, uint256 share) internal {
        //checkpoint before userCollateralShare is changed
        ICheckpointTokenV2(address(collateral)).onCheckpoint(msg.sender);
    ...
    function liquidate(
        ...
        for (uint256 i = 0; i < users.length; i++) {
            ...
            if (!_isSolvent(user, _exchangeRate)) {
                ...
                //checkpoint before userCollateralShare is changed
                ICheckpointTokenV2(address(collateral)).onCheckpoint(user);
    ...
    function userCollateralAmount(address account) public view override returns (uint256) {
        return bentoBox.toAmount(collateral, userCollateralShare[account], false); 
    }
}
