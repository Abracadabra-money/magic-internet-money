...
import { BentoBoxV1, CauldronV2, IERC20, IOracle } from "../typechain";
...
describe("Popsicle USDC/WETH Cauldron", async () => {
  ...
  before(async () => {
    ...
    USDC = await ethers.getContractAt<IERC20>("ERC20Mock", "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48");
    WETH = await ethers.getContractAt<IERC20>("ERC20Mock", "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2");
